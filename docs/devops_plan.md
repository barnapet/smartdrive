...
3.  **Unit & Logic Testing:** **(v1.3 Update)** Automated execution of test cases validating the **11.5V Smart Guard Sentinel Alert** and the **Ignition-priority sampling trigger**.
